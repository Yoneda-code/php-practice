...
// 問題2
$count = 1;
foreach ($personalInfos as $list) {
    echo $count . '番目の' . $list['name'] . 'のメールアドレスは' . $list['mail'] . 'で、電話番号は' . $list['tel'] . "です。\n";
    $count++;
}
...
$watanabe = new Student(120,'渡辺');
echo '学籍番号'. $watanabe->studentId . '番の生徒は' . $watanabe->studentName . 'です。';
